...
public class MeFragmentForYangJia extends BaseFragment implements
	...
	public void onClick(View v) {
		...
		case R.id.tv_store:// 店铺首页
			ToolsUtil.forwardShopMainActivity(getActivity(),Integer.valueOf(SharedUtil.getUserId(getActivity())));
			break;
		...
		case R.id.tv_invite_buyer:// 邀请买手
			ShareUtil.shareAll(getActivity(), "",shareContent, SharedUtil.getUpdateUrl(getActivity()), "",null);
			break;
