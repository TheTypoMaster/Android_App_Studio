...
public class BaiJiaShareDataActivity extends BaseActivityWithTopView{
	...
	{   
		...
		tv_top_right.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				//获取已经选择的对象
				ArrayList<BaiJiaShareInfoBean>  check_list=getCheckList();
				...
				}else
				{
					...
					result_intent.putExtra("RESULT_DATA",check_list);
	 ...
	 * 获取选中的对象
	 * ***/
	ArrayList<BaiJiaShareInfoBean> getCheckList()
	{
		ArrayList<BaiJiaShareInfoBean> check_list=new ArrayList<BaiJiaShareInfoBean>();
